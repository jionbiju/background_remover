...
//       <h1 className="mb-12 sm:mb-20 text-center pb-1 text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-500 bg-clip-text text-transparent">
//         Remove Background With High <br /> Quality and Accuracy
//       </h1>
//       <div className="flex flex-wrap px-3 sm:px-24 mb-10">

//         {/*Left Side*/}
//         <div className="w-1/2 items-center mt-20">
//           <h1 className="sm:text-4xl text-lg pb-6 font-semibold">
...
//           </p>
//         </div>
//         <div className="relative w-full max-w-[460px] overflow-hidden m-auto rounded-xl">
//           {/*Background image*/}
//           <img
